(function ($) {
    ...
    spark1(sparklineData);
    spark2(sparklineData);
    spark3(sparklineData);
    line();
    gredLine();
    stackArea();
    column();
...
function spark2(sparklineData) {
    var chartColors = [colors.gray700];
    ...
    new ApexCharts(document.querySelector("#spark2"), options).render();
}

function spark3(sparklineData) {
    ...
    new ApexCharts(document.querySelector("#spark3"), options).render();
}
...
function stackArea() {
    var chartColors = [colors.primary, colors.warning, colors.gray400];
...
function column() {
    var chartColors = [colors.primary, colors.success, colors.danger];
...
function mixed() {
    var chartColors = ["rgba(0,0,0,0.08)", colors.primary];
...
function minusBar() {
    var chartColors = [colors.info, colors.primary];
...
function mixed2() {
    var chartColors = [colors.primary, colors.warning, colors.info];
...
function mixed3() {
    var chartColors = [colors.primary, colors.danger, colors.info];
...
function bubble() {
    var chartColors = [colors.primary, colors.danger, colors.success];
...
function bubble2() {
    var chartColors = [colors.primary, colors.danger, colors.success, colors.secondary];
...
function scatter() {
    var chartColors = [colors.danger, colors.primary, colors.secondary];
...
function scatter2() {
    ...
    var chartColors = [colors.danger, colors.primary, colors.secondary, colors.success, colors.warning];
...
function candleStick2() {
    var chartColors = [colors.primary, colors.warning];
    ...
    window.chartCandlestick = chartCandlestick;
    chartCandlestick.render();
}

function candleStick3() {
    var chartColors = [colors.danger, colors.info];
    ...
    var options = {
        chart: {
            ...
            events: {
                selection: function (chart, e) {
                    window.chartCandlestick.updateOptions({
                        xaxis: {
                            min: e.xaxis.min,
                            max: e.xaxis.max
                        }
...
function pie() {
    var chartColors = [colors.primary,colors.warning,colors.success,colors.danger,colors.info];
...
function pie2() {
    var chartColors =  [colors.primary,colors.secondary,colors.success,colors.danger,colors.info];
...
function pie3() {
    var chartColors =  [colors.warning,colors.danger,colors.success,colors.primary,colors.info];
...
function radial2() {
    var chartColors = [colors.primary, colors.secondary, colors.warning, colors.danger];
